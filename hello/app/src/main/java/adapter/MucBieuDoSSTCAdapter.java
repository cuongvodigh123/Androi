...
public class MucBieuDoSSTCAdapter extends ArrayAdapter<MucBieuDoSSTC> {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        barChartItemIncome.setText("Thu nhập: " + String.format("%.1f",m.getIncome()) + " đ");
        barChartItemExpense.setText("Chi phí: " + String.format("%.1f",m.getExpense()) + " đ");
        barChartItemProfit.setText("Lợi nhuận: " + String.format("%.1f",m.getProfit()) + " đ");
